...
public interface AccountController {
    ...
    void banUser(@RequestBody OneParamRequest<String> password, @PathVariable("userId") UUID userId, @RequestHeader(Constants.ACCESS_TOKEN_HEADER) AccessTokenHeader accessTokenHeader);
}
