...
public interface SkyXplorePlanetPopulationController {
    ...
    CitizenResponse renameCitizen(@RequestBody OneParamRequest<String> newName, @PathVariable("planetId") UUID planetId, @PathVariable("citizenId") UUID citizenId, @RequestHeader(Constants.ACCESS_TOKEN_HEADER) AccessTokenHeader accessTokenHeader);
}
