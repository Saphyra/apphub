...
public interface EncryptionKeyApiController {
    ...
    String createEncryptionKey(@RequestBody EncryptionKey request, @PathVariable("accessMode") AccessMode accessMode, @RequestHeader(Constants.ACCESS_TOKEN_HEADER) AccessToken accessToken);
    ...
    void deleteEncryptionKey(@PathVariable("dataType") DataType dataType, @PathVariable("externalId") UUID externalId, @PathVariable("accessMode") AccessMode accessMode, @RequestHeader(Constants.ACCESS_TOKEN_HEADER) AccessToken accessToken);
    ...
    String getEncryptionKey(@PathVariable("dataType") DataType dataType, @PathVariable("externalId") UUID externalId, @PathVariable("accessMode") AccessMode accessMode, @RequestHeader(Constants.ACCESS_TOKEN_HEADER) AccessToken accessToken);
}
