...
public interface SharedDataController {
     ...
     */
    @GetMapping(EncryptionEndpoints.ENCRYPTION_INTERNAL_GET_SHARED_DATA)
     ...
     */
    @PutMapping(EncryptionEndpoints.ENCRYPTION_INTERNAL_CREATE_SHARED_DATA)
     ...
     */
    @PutMapping(EncryptionEndpoints.ENCRYPTION_INTERNAL_CLONE_SHARED_DATA)
     ...
     */
    @DeleteMapping(EncryptionEndpoints.ENCRYPTION_INTERNAL_DELETE_SHARED_DATA_ENTITY)
     ...
     */
    @DeleteMapping(EncryptionEndpoints.ENCRYPTION_INTERNAL_DELETE_SHARED_DATA)
