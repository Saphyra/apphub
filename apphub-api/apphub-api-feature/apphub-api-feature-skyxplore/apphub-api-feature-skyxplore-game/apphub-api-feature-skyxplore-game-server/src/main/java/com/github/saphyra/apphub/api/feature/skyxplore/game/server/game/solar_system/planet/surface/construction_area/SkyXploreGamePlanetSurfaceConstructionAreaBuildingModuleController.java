package com.github.saphyra.apphub.api.feature.skyxplore.game.server.game.solar_system.planet.surface.construction_area;
...
public interface SkyXploreGamePlanetSurfaceConstructionAreaBuildingModuleController {
    ...
    List<BuildingModuleResponse> getBuildingModules(@PathVariable("constructionAreaId") UUID constructionAreaId, @RequestHeader(Constants.ACCESS_TOKEN_HEADER) AccessToken accessToken);
    ...
    List<BuildingModuleResponse> cancelConstructionOfBuildingModule(@PathVariable("constructionId") UUID constructionId, @RequestHeader(Constants.ACCESS_TOKEN_HEADER) AccessToken accessToken);

    @DeleteMapping(SkyXploreGameEndpoints.SKYXPLORE_PLANET_SURFACE_CONSTRUCTION_AREA_DECONSTRUCT_BUILDING_MODULE)
    List<BuildingModuleResponse> deconstructBuildingModule(@PathVariable("buildingModuleId") UUID buildingModuleId, @RequestHeader(Constants.ACCESS_TOKEN_HEADER) AccessToken accessToken);

    @DeleteMapping(SkyXploreGameEndpoints.SKYXPLORE_PLANET_SURFACE_CONSTRUCTION_AREA_CANCEL_DECONSTRUCTION_OF_BUILDING_MODULE)
    List<BuildingModuleResponse> cancelDeconstructionOfBuildingModule(@PathVariable("deconstructionId") UUID deconstructionId, @RequestHeader(Constants.ACCESS_TOKEN_HEADER) AccessToken accessToken);
}
