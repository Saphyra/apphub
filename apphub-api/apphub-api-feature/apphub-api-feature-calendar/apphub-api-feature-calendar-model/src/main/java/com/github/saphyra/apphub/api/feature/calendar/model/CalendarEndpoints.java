...
public class CalendarEndpoints {
    ...
    public static final String CALENDAR_EDIT_OCCURRENCE = "/api/calendar/{eventId}/occurrences/{occurrenceId}"; //TODO Added eventId pathVariable
    ...
    public static final String CALENDAR_GET_OCCURRENCE = "/api/calendar/{eventId}/occurrences/{occurrenceId}"; //TODO Added eventId pathVariable
    public static final String CALENDAR_EDIT_OCCURRENCE_STATUS = "/api/calendar/{eventId}/occurrences/{occurrenceId}/status"; //TODO Added eventId pathVariable
    public static final String CALENDAR_DELETE_OCCURRENCE = "/api/calendar/occurrences/{occurrenceId}";
    public static final String CALENDAR_OCCURRENCE_REMINDED = "/api/calendar/{eventId}/occurrences/{occurrenceId}/reminded"; //TODO Added eventId pathVariable
