...
public interface OrganizationController {
    ...
    @GetMapping(TaskManagerEndpoints.TASK_MANAGER_GET_ORGANIZATION)
    OrganizationResponse getOrganization(@PathVariable("organizationId") UUID organizationId, @RequestHeader(Constants.ACCESS_TOKEN_HEADER) AccessToken accessToken);
}
