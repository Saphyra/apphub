...
public interface StockItemController {
    @PutMapping(VillanyAteszEndpoints.VILLANY_ATESZ_CREATE_STOCK_ITEM)
    ...
    @GetMapping(VillanyAteszEndpoints.VILLANY_ATESZ_GET_STOCK_ITEMS)
    ...
    @GetMapping(VillanyAteszEndpoints.VILLANY_ATESZ_GET_STOCK_ITEMS_FOR_CATEGORY)
    ...
    @PostMapping(VillanyAteszEndpoints.VILLANY_ATESZ_STOCK_ACQUIRE)
    ...
    @PostMapping(VillanyAteszEndpoints.VILLANY_ATESZ_FIND_STOCK_ITEM_BY_BAR_CODE)
    ...
    @GetMapping(VillanyAteszEndpoints.VILLANY_ATESZ_FIND_BAR_CODE_BY_STOCK_ITEM_ID)
    ...
    @GetMapping(VillanyAteszEndpoints.VILLANY_ATESZ_GET_STOCK_ITEM)
