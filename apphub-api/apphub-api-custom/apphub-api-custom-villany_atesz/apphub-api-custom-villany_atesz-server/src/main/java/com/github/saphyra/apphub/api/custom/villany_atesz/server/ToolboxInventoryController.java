...
public interface ToolboxInventoryController {
    @PostMapping(VillanyAteszEndpoints.VILLANY_ATESZ_TOOLBOX_INVENTORY_EDIT_STORAGE_BOX)
    ...
    @PostMapping(VillanyAteszEndpoints.VILLANY_ATESZ_TOOLBOX_INVENTORY_EDIT_TOOL_TYPE)
    ...
    @PostMapping(VillanyAteszEndpoints.VILLANY_ATESZ_TOOLBOX_INVENTORY_EDIT_BRAND)
    ...
    @PostMapping(VillanyAteszEndpoints.VILLANY_ATESZ_TOOLBOX_INVENTORY_EDIT_NAME)
    ...
    @PostMapping(VillanyAteszEndpoints.VILLANY_ATESZ_TOOLBOX_INVENTORY_EDIT_COST)
    ...
    @PostMapping(VillanyAteszEndpoints.VILLANY_ATESZ_TOOLBOX_INVENTORY_EDIT_ACQUIRED_AT)
    ...
    @PostMapping(VillanyAteszEndpoints.VILLANY_ATESZ_TOOLBOX_INVENTORY_EDIT_WARRANTY_EXPIRES_AT)
    ...
    @PostMapping(VillanyAteszEndpoints.VILLANY_ATESZ_TOOLBOX_INVENTORY_EDIT_STATUS)
    ...
    @PostMapping(VillanyAteszEndpoints.VILLANY_ATESZ_TOOLBOX_INVENTORY_EDIT_SCRAPPED_AT)
    ...
    @PostMapping(VillanyAteszEndpoints.VILLANY_ATESZ_TOOLBOX_INVENTORY_EDIT_INVENTORIED)
    ...
    @PostMapping(VillanyAteszEndpoints.VILLANY_ATESZ_TOOLBOX_INVENTORY_RESET_INVENTORIED)
