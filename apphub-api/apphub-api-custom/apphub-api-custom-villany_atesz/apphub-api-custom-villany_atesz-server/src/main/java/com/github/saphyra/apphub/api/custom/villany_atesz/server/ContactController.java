...
public interface ContactController {
    @PutMapping(VillanyAteszEndpoints.VILLANY_ATESZ_CREATE_CONTACT)
    ...
    @PostMapping(VillanyAteszEndpoints.VILLANY_ATESZ_EDIT_CONTACT)
    ...
    @DeleteMapping(VillanyAteszEndpoints.VILLANY_ATESZ_DELETE_CONTACT)
    ...
    @GetMapping(VillanyAteszEndpoints.VILLANY_ATESZ_GET_CONTACTS)
