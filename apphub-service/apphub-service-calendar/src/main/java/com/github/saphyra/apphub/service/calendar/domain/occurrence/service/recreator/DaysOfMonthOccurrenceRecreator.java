...
@Slf4j
//TODO unit test
class DaysOfMonthOccurrenceRecreator implements OccurrenceRecreator {
    ...
    public void recreateOccurrences(UpdateEventContext context) {
        ...
        Set<Integer> daysOfWeek = objectMapperWrapper.convertValue(event.getRepetitionData(), typeReference);
        ...
        while (!date.isAfter(endDate)) {
            boolean shouldHaveOccurrence = daysOfWeek.contains(date.getDayOfMonth());
