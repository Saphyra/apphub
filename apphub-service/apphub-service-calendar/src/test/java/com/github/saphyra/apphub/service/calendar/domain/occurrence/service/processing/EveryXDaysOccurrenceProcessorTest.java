...
class EveryXDaysOccurrenceProcessorTest {
    @InjectMocks
    private EveryXDaysOccurrenceProcessor underTest;

    @Test
    void getRepetitionType() {
        assertThat(underTest.getRepetitionType()).isEqualTo(RepetitionType.EVERY_X_DAYS);
    }
}