...
class DaysOfWeekOccurrenceProcessorTest {
    @InjectMocks
    private DaysOfWeekOccurrenceProcessor underTest;

    @Test
    void getRepetitionType() {
        assertThat(underTest.getRepetitionType()).isEqualTo(RepetitionType.DAYS_OF_WEEK);
    }
}