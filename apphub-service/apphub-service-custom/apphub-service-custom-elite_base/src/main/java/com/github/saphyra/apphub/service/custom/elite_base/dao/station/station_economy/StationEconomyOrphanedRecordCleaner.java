...
@Slf4j
//TODO unit test
class StationEconomyOrphanedRecordCleaner extends OrphanedRecordCleaner {
    private final JdbcTemplate jdbcTemplate;

    StationEconomyOrphanedRecordCleaner(ErrorReporterService errorReporterService, JdbcTemplate jdbcTemplate) {
    ...
    protected int doCleanup() {
        String sql = SqlBuilder.delete()
            ...
            .condition(new NotExistsCondition(SqlBuilder.select()
                ...
                .condition(new Equation(new QualifiedColumn(TABLE_STATION, COLUMN_ID), new QualifiedColumn(TABLE_STATION_ECONOMY, COLUMN_STATION_ID)))
            ))
            .build();
