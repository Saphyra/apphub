...
@Component
@Slf4j
class SpaceshipDeleteBuffer extends DeleteBuffer<ItemDomainId> {
    private final JdbcTemplate jdbcTemplate;

    protected SpaceshipDeleteBuffer(DateTimeUtil dateTimeUtil, JdbcTemplate jdbcTemplate) {
        super(dateTimeUtil);
    ...
    protected void doSynchronize(Collection<ItemDomainId> domains) {
        ...
        log.debug("Deleting Spaceships by externalReferences {} and commodityNames {}", externalReferences, commodityNames);
