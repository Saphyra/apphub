...
@Component
@Slf4j
class EquipmentDeleteBuffer extends DeleteBuffer<ItemDomainId> {
    private final JdbcTemplate jdbcTemplate;

    protected EquipmentDeleteBuffer(DateTimeUtil dateTimeUtil, JdbcTemplate jdbcTemplate) {
        super(dateTimeUtil);
    ...
    protected void doSynchronize(Collection<ItemDomainId> domains) {
        ...
        log.debug("Deleting Equipments by externalReferences {} and commodityNames {}", externalReferences, commodityNames);
