...
class FcMaterialDaoTest {
    ...
    @Mock
    private FcMaterialConverter converter;

    @Mock
    private FcMaterialRepository repository;

    @Mock
    private Cache<Long, List<FcMaterial>> readCache;

    @Mock
    private FcMaterialWriteBuffer writeBuffer;

    @Mock
    private FcMaterialDeleteBuffer deleteBuffer;

    @InjectMocks
    private FcMaterialDao underTest;

    @Mock
    private FcMaterial domain;

    @Mock
    private FcMaterialEntity entity;
    ...
    void getByMarketId_cached() {
        ...
        List<FcMaterial> result = underTest.getByMarketId(MARKET_ID);
