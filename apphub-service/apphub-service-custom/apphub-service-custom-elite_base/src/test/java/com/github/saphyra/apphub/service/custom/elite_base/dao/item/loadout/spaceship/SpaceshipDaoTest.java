...
class SpaceshipDaoTest {
    ...
    @Mock
    private Cache<Long, List<Spaceship>> readCache;

    @Mock
    private SpaceshipWriteBuffer writeBuffer;

    @Mock
    private SpaceshipDeleteBuffer deleteBuffer;

    @InjectMocks
    private SpaceshipDao underTest;
    ...
    void getByMarketId_cached() {
        ...
        List<Spaceship> result = (List<Spaceship>) underTest.getByMarketId(MARKET_ID);
