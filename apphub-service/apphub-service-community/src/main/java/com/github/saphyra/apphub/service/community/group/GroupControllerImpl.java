...
import com.github.saphyra.apphub.service.community.group.service.RenameGroupService;
...
public class GroupControllerImpl implements GroupController {
    ...
    private final RenameGroupService renameGroupService;
    ...
    public GroupListResponse renameGroup(OneParamRequest<String> groupName, UUID groupId, AccessTokenHeader accessTokenHeader) {
        ...
        return renameGroupService.rename(accessTokenHeader.getUserId(), groupId, groupName.getValue());
    }
