...
class CommodityOrphanedRecordCleaner extends BatchOrphanedRecordCleaner {
    ...
    public CommodityOrphanedRecordCleaner(ErrorReporterService errorReporterService, MonitoringInstruments monitoringInstruments, JdbcTemplate jdbcTemplate, EliteBaseProperties eliteBaseProperties) {
    ...
    public Orphanage getOrphanage() {
        return Orphanage.ITEM_COMMODITY;
    }
