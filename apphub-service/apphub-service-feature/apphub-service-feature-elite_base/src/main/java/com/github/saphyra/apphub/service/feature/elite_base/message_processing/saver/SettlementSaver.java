...
import com.github.saphyra.apphub.service.feature.elite_base.dao.settlement.Settlement;
import com.github.saphyra.apphub.service.feature.elite_base.dao.settlement.SettlementDao;
import com.github.saphyra.apphub.service.feature.elite_base.dao.settlement.SettlementFactory;
...
public class SettlementSaver {
    ...
    public synchronized void save(LocalDateTime timestamp, UUID starSystemId, UUID bodyId, String settlementName, Long marketId, Double longitude, Double latitude) {
        ...
        log.debug("Saving settlement {}", settlementName);
        ...
        log.debug("Saved settlement {}", settlementName);
    }
