...
import com.github.saphyra.apphub.service.feature.elite_base.message_processing.structure.nav_beacon_scan.NavBeaconScanMessage;
...
class NavBeaconScanMessageProcessorTest {
    ...
    @InjectMocks
    private NavBeaconScanMessageProcessor underTest;
    ...
    @Test
    void canProcess() {
        given(edMessage.getSchemaRef()).willReturn(SchemaRefs.NAV_BEACON_SCAN);
    ...
    @Test
    void processMessage() {
        NavBeaconScanMessage navBeaconScanMessage = NavBeaconScanMessage.builder()
            .timestamp(TIMESTAMP)
            .starId(STAR_ID)
            .starName(STAR_NAME)
        ...
        given(objectMapper.readValue(MESSAGE, NavBeaconScanMessage.class)).willReturn(navBeaconScanMessage);
