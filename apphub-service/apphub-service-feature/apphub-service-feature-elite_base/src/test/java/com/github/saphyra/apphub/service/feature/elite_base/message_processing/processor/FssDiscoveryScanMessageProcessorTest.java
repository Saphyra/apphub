...
import com.github.saphyra.apphub.service.feature.elite_base.message_processing.structure.fss_discovery_scan.FssDiscoveryScanMessage;
...
class FssDiscoveryScanMessageProcessorTest {
    ...
    void processMessage() {
        ...
        given(objectMapper.readValue(MESSAGE, FssDiscoveryScanMessage.class)).willReturn(fssDiscoveryScanMessage);
