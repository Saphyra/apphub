...
import com.github.saphyra.apphub.service.feature.elite_base.message_processing.structure.fss_signal_discovered.FssSignalDiscoveredMessage;
...
class FssSignalDiscoveredMessageProcessorTest {
    ...
    void processMessage() {
        ...
        given(objectMapper.readValue(MESSAGE, FssSignalDiscoveredMessage.class)).willReturn(fssSignalDiscoveredMessage);
