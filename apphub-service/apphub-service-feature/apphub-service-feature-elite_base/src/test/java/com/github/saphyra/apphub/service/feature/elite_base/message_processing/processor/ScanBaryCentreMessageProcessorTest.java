...
import com.github.saphyra.apphub.service.feature.elite_base.message_processing.structure.scan_bary_centre.ScanBaryCentreMessage;
...
class ScanBaryCentreMessageProcessorTest {
    ...
    void processMessage() {
        ...
        given(objectMapper.readValue(MESSAGE, ScanBaryCentreMessage.class)).willReturn(fssAllBodiesFoundMessage);
