...
class DeprecatedOccurrenceDaoTest {
    ...
    @Mock
    private DeprecatedOccurrenceConverter converter;

    @Mock
    private DeprecatedOccurrenceRepository repository;

    @InjectMocks
    private DeprecatedOccurrenceDao underTest;

    @Mock
    private DeprecatedOccurrenceEntity entity;

    @Mock
    private DeprecatedOccurrence domain;
