...
class DeprecatedEventLabelMappingDaoTest {
    ...
    @Mock
    private DeprecatedEventLabelMappingConverter converter;

    @Mock
    private DeprecatedEventLabelMappingRepository repository;

    @InjectMocks
    private DeprecatedEventLabelMappingDao underTest;

    @Mock
    private DeprecatedEventLabelMappingEntity entity;

    @Mock
    private DeprecatedEventLabelMapping domain;
