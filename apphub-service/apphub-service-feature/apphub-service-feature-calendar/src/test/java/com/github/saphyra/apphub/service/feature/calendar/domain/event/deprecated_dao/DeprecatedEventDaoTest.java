...
class DeprecatedEventDaoTest {
    ...
    @Mock
    private DeprecatedEventRepository repository;

    @Mock
    private DeprecatedEventConverter converter;

    @InjectMocks
    private DeprecatedEventDao underTest;

    @Mock
    private DeprecatedEventEntity entity;

    @Mock
    private DeprecatedEvent domain;
