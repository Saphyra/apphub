...
class EventLabelMappingConverterTest {
    ...
    void convertDomain() {
        ...
        assertThat(underTest.convertDomain(domain))
            .returns(USER_ID_1_STRING, EventLabelMappingEntity::getUserId)
            .returns(EVENT_ID_STRING, EventLabelMappingEntity::getEventId)
            .returns(Map.of(LABEL_ID_STRING, USER_ID_2_STRING), EventLabelMappingEntity::getLabelIds);
    }
    ...
    void convertEntity() {
        EventLabelMappingEntity entity = EventLabelMappingEntity.builder()
            ...
            .labelIds(Map.of(LABEL_ID_STRING, USER_ID_2_STRING))
            .build();
        ...
        assertThat(underTest.convertEntity(entity))
            .returns(USER_ID_1, EventLabelMapping::getUserId)
            .returns(EVENT_ID, EventLabelMapping::getEventId)
            .returns(Map.of(LABEL_ID, USER_ID_2), EventLabelMapping::getLabelIds);
    }
}