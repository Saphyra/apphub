...
class DeprecatedEventLabelMappingRepositoryTest {
    ...
    @Autowired
    private DeprecatedEventLabelMappingRepository underTest;
    ...
    @Transactional
    void deleteByUserId() {
        DeprecatedEventLabelMappingEntity entity1 = DeprecatedEventLabelMappingEntity.builder()
            .labelId(LABEL_ID_1)
            .userId(USER_ID_1)
            .eventId(EVENT_ID_1)
            .build();
        underTest.save(entity1);
        DeprecatedEventLabelMappingEntity entity2 = DeprecatedEventLabelMappingEntity.builder()
            .labelId(LABEL_ID_1)
            .userId(USER_ID_2)
            .eventId(EVENT_ID_2)
            .build();
    ...
    void deleteByUserIdAndLabelId() {
        ...
        DeprecatedEventLabelMappingEntity entity2 = DeprecatedEventLabelMappingEntity.builder()
            ...
            .build();
        underTest.save(entity2);
        DeprecatedEventLabelMappingEntity entity3 = DeprecatedEventLabelMappingEntity.builder()
            .labelId(LABEL_ID_1)
            .userId(USER_ID_2)
            .eventId(EVENT_ID_2)
            .build();
