...
class DeprecatedLabelDaoTest {
    ...
    @Mock
    private DeprecatedLabelConverter converter;

    @Mock
    private DeprecatedLabelRepository repository;

    @InjectMocks
    private DeprecatedLabelDao underTest;

    @Mock
    private DeprecatedLabel domain;

    @Mock
    private DeprecatedLabelEntity entity;
