...
class DeprecatedOccurrenceRepositoryTest {
    ...
    @Autowired
    private DeprecatedOccurrenceRepository underTest;
    ...
    @Transactional
    void deleteByUserId() {
        DeprecatedOccurrenceEntity entity1 = DeprecatedOccurrenceEntity.builder()
            .occurrenceId(ID_1)
            .userId(USER_ID_1)
            .build();
        underTest.save(entity1);
        DeprecatedOccurrenceEntity entity2 = DeprecatedOccurrenceEntity.builder()
            .occurrenceId(ID_2)
            .userId(USER_ID_2)
            .build();
    ...
    void deleteByUserIdAndEventId(){
        ...
        DeprecatedOccurrenceEntity entity2 = DeprecatedOccurrenceEntity.builder()
            ...
            .build();
        underTest.save(entity2);
        DeprecatedOccurrenceEntity entity3 = DeprecatedOccurrenceEntity.builder()
            .occurrenceId(ID_3)
            .userId(USER_ID_1)
            .eventId(EVENT_ID_2)
            .build();
