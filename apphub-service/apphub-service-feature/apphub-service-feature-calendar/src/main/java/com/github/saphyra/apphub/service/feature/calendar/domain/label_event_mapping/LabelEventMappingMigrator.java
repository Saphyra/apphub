package com.github.saphyra.apphub.service.feature.calendar.domain.label_event_mapping;
...
@Slf4j
@Profile("!test")
class LabelEventMappingMigrator extends DynamoDbRepository {
    ...
    LabelEventMappingMigrator(CalendarDynamoDbConfiguration configuration, DynamoDbRepositoryContext context, ObjectMapper objectMapper, ErrorReporterService errorReporterService) {
