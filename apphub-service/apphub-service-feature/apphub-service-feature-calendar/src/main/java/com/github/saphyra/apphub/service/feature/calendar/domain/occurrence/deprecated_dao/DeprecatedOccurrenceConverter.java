...
class DeprecatedOccurrenceConverter extends ConverterBase<DeprecatedOccurrenceEntity, DeprecatedOccurrence> {
    ...
    private final DeprecatedOccurrenceRepository occurrenceRepository;

    @Override
    protected DeprecatedOccurrenceEntity processDomainConversion(DeprecatedOccurrence domain) {
        ...
        return DeprecatedOccurrenceEntity.builder()
    ...
    @Override
    protected DeprecatedOccurrence processEntityConversion(DeprecatedOccurrenceEntity entity) {
        String userIdFromAccessToken = accessTokenProvider.getUserIdAsString();
        ...
        return DeprecatedOccurrence.builder()
