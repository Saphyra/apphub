...
class InvitationServiceTest {
	...
	void acceptInvitation() {
		...
		then(notificationService).should().createUserAcceptedYourInvitationNotification(List.of(INVITED_BY_1, INVITED_BY_2), USER_ID);
	}
	...
	void rejectInvitation() {
		...
		then(notificationService).should().createUserRejectedYourInvitationNotification(List.of(INVITED_BY_1, INVITED_BY_2), USER_ID);
		then(invitationDao).should().delete(List.of(invitation1, invitation2));
	}
