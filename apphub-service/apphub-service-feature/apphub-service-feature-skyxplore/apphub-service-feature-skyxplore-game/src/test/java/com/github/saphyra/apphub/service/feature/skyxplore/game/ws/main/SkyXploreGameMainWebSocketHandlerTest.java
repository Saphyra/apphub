package com.github.saphyra.apphub.service.feature.skyxplore.game.ws.main;
...
import com.github.saphyra.apphub.service.feature.skyxplore.game.ws.main.service.PlayerConnectedService;
import com.github.saphyra.apphub.service.feature.skyxplore.game.ws.main.service.PlayerDisconnectedService;
...
class SkyXploreGameMainWebSocketHandlerTest {
    ...
    @Test
    void getEndpoint() {
        assertThat(underTest.getEndpoint()).isEqualTo(GenericSkyXploreEndpoints.WS_CONNECTION_SKYXPLORE_GAME);
    }
