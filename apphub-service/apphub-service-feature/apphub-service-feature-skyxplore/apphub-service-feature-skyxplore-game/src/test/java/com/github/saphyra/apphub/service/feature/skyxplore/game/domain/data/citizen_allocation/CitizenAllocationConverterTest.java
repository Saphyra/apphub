package com.github.saphyra.apphub.service.feature.skyxplore.game.domain.data.citizen_allocation;
...
class CitizenAllocationConverterTest {
    ...
    private final CitizenAllocationConverter underTest = new CitizenAllocationConverter();
    ...
    void convert() {
        ...
        CitizenAllocationModel result = underTest.toModel(GAME_ID, citizenAllocation);
