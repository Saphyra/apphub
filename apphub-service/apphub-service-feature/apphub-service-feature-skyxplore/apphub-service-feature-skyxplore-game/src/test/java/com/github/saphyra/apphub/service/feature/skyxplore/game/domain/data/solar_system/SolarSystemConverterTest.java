package com.github.saphyra.apphub.service.feature.skyxplore.game.domain.data.solar_system;
...
class SolarSystemConverterTest {
    ...
    private final SolarSystemConverter underTest = new SolarSystemConverter();
    ...
    void toModel() {
        ...
        SolarSystemModel result = underTest.toModel(GAME_ID, solarSystem);
