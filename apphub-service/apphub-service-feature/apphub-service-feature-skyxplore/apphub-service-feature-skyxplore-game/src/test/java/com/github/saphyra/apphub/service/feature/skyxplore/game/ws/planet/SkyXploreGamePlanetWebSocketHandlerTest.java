package com.github.saphyra.apphub.service.feature.skyxplore.game.ws.planet;
...
class SkyXploreGamePlanetWebSocketHandlerTest {
    ...
    @Test
    void getEndpoint() {
        assertThat(underTest.getEndpoint()).isEqualTo(GenericSkyXploreEndpoints.WS_CONNECTION_SKYXPLORE_GAME_PLANET);
    }
