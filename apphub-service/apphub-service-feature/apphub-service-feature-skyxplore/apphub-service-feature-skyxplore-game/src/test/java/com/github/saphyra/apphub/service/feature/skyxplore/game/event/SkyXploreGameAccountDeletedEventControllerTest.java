package com.github.saphyra.apphub.service.feature.skyxplore.game.event;
...
public class SkyXploreGameAccountDeletedEventControllerTest {
    ...
    public void hostDeleted() {
        ...
        then(webSocketHandler).should().sendEvent(List.of(USER_ID), WebSocketEventName.REDIRECT, GenericSkyXploreEndpoints.SKYXPLORE_MAIN_MENU_PAGE);
