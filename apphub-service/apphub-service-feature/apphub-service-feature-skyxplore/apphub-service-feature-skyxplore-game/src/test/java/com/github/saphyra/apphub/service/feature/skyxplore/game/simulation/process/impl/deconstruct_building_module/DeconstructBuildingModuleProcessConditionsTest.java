...
class DeconstructBuildingModuleProcessConditionsTest {
    private static final UUID PROCESS_ID = UUID.randomUUID();

    @InjectMocks
    private DeconstructBuildingModuleProcessConditions underTest;
    ...
    void hasWorkProcesses() {
        ...
        assertThat(underTest.hasWorkProcess(gameData, PROCESS_ID)).isTrue();
    }
