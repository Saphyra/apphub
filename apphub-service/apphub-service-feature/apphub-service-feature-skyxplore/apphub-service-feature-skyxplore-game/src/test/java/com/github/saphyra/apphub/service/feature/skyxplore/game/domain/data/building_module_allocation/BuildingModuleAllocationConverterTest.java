package com.github.saphyra.apphub.service.feature.skyxplore.game.domain.data.building_module_allocation;
...
class BuildingModuleAllocationConverterTest {
    ...
    private final BuildingModuleAllocationConverter underTest = new BuildingModuleAllocationConverter();

    @Test
    void convert() {
        BuildingModuleAllocation buildingModuleAllocation = BuildingModuleAllocation.builder()
            .buildingModuleAllocationId(BUILDING_ALLOCATION_ID)
        ...
        assertThat(result.getType()).isEqualTo(GameItemType.BUILDING_MODULE_ALLOCATION);
