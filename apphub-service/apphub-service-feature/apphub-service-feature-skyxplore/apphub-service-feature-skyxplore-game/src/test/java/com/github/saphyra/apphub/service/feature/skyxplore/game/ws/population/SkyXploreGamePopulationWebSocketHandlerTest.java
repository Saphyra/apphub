package com.github.saphyra.apphub.service.feature.skyxplore.game.ws.population;
...
class SkyXploreGamePopulationWebSocketHandlerTest {
    ...
    @InjectMocks
    private SkyXploreGamePopulationWebSocketHandler underTest;
    ...
    @Test
    void getEndpoint() {
        assertThat(underTest.getEndpoint()).isEqualTo(GenericSkyXploreEndpoints.WS_CONNECTION_SKYXPLORE_GAME_POPULATION);
    }
