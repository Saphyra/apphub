...
public class ProductionDispatcherProcess implements Process {
    ...
    public void cleanup() {
        ...
        gameData.getProductionRequests()
            .findById(productionRequestId)
            .ifPresent(productionRequest -> {
                gameData.getProductionRequests()
                    .remove(productionRequest);
                progressDiff.delete(productionRequestId, GameItemType.PRODUCTION_REQUEST, productionRequest.isExisting());
            });
