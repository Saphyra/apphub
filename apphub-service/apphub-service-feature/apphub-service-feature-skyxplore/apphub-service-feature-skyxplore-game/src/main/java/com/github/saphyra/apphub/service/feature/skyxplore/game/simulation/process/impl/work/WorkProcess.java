...
/**
 * Handles workPoint generation of citizens
 */
@Slf4j
...
public class WorkProcess implements Process {
    ...
    /**
     * <ol>
     *     <li>Makes sure only one WorkProcess of the same parent is in progress at the same time</li>
     *     <li>Waits until a citizen is available, then allocates them to this task</li>
     *     <li>Makes the citizen generate workPoints each tick</li>
     *     <li>Once the requested amount of workPoints are generated by the citizen, the citizen is released, and the work is done.</li>
     * </ol>
     */
    @Override
    public void work() {
