...
@Slf4j
class ConstructConstructionAreaProcessConditions {
    ...
    boolean resourcesAvailable(GameData gameData, UUID processId, UUID constructionId) {
        ...
        String dataId = gameData.getConstructionAreas()
            .findByIdValidated(constructionAreaId)
            .getDataId();
        Map<String, Integer> requiredResources = constructionAreaDataService.get(dataId)
