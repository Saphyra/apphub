...
class ResourceDeliveryRequestServiceTest {
    ...
    @Mock
    private ResourceDeliveryRequestDao dao;

    @InjectMocks
    private ResourceDeliveryRequestService underTest;
    ...
    @Test
    public void getType() {
        assertThat(underTest.getType()).isEqualTo(GameItemType.RESOURCE_DELIVERY_REQUEST);
    }
