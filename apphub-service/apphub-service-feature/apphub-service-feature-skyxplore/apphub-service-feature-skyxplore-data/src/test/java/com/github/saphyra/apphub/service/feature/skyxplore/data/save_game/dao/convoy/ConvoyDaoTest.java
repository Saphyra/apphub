package com.github.saphyra.apphub.service.feature.skyxplore.data.save_game.dao.convoy;
...
class ConvoyDaoTest {
    ...
    @Mock
    private ConvoyRepository repository;

    @Mock
    private ConvoyConverter converter;

    @InjectMocks
    private ConvoyDao underTest;

    @Mock
    private ConvoyEntity entity;
