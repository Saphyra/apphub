package com.github.saphyra.apphub.service.feature.skyxplore.data.save_game.dao.construction_area;
...
class ConstructionAreaServiceTest {
    ...
    @Mock
    private ConstructionAreaDao dao;

    @InjectMocks
    private ConstructionAreaService underTest;

    @Mock
    private ConstructionAreaModel model;

    @Test
    public void getType() {
        assertThat(underTest.getType()).isEqualTo(GameItemType.CONSTRUCTION_AREA);
    }
