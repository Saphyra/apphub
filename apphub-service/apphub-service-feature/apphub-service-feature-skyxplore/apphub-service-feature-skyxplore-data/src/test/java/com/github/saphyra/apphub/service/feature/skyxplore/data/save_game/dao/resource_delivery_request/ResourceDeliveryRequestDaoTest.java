package com.github.saphyra.apphub.service.feature.skyxplore.data.save_game.dao.resource_delivery_request;
...
class ResourceDeliveryRequestDaoTest {
    ...
    @Mock
    private ResourceDeliveryRequestRepository repository;

    @Mock
    private ResourceDeliveryRequestConverter converter;

    @InjectMocks
    private ResourceDeliveryRequestDao underTest;

    @Mock
    private ResourceDeliveryRequestEntity entity;
