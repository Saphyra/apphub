package com.github.saphyra.apphub.service.feature.skyxplore.data.save_game.dao.production_request;
...
class ProductionRequestDaoTest {
    ...
    @Mock
    private ProductionRequestRepository repository;

    @Mock
    private ProductionRequestConverter converter;

    @InjectMocks
    private ProductionRequestDao underTest;

    @Mock
    private ProductionRequestEntity entity;
