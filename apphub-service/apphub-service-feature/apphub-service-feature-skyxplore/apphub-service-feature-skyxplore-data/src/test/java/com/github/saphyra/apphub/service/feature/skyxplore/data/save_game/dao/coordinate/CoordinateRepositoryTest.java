package com.github.saphyra.apphub.service.feature.skyxplore.data.save_game.dao.coordinate;
...
public class CoordinateRepositoryTest {
    ...
    private static final String COORDINATE_ID_3 = "coordinate-id-3";
    private static final String COORDINATE_ID_4 = "coordinate-id-4";
    ...
    void getByGameId() {
        ...
        CoordinateEntity entity2 = CoordinateEntity.builder()
            ...
            .gameId(GAME_ID_1)
            .build();
        CoordinateEntity entity3 = CoordinateEntity.builder()
            .coordinateId(COORDINATE_ID_3)
            .gameId(GAME_ID_1)
            .build();
        CoordinateEntity entity4 = CoordinateEntity.builder()
            .coordinateId(COORDINATE_ID_4)
            .gameId(GAME_ID_2)
            .build();
