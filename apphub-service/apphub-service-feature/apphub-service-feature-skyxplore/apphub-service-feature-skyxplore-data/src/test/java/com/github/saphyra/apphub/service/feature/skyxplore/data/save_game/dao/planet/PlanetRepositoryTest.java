package com.github.saphyra.apphub.service.feature.skyxplore.data.save_game.dao.planet;
...
public class PlanetRepositoryTest {
    ...
    private static final String PLANET_ID_3 = "planet-id-3";
    private static final String PLANET_ID_4 = "planet-id-4";
    ...
    void getByGameId() {
        ...
        PlanetEntity entity2 = PlanetEntity.builder()
            ...
            .gameId(GAME_ID_1)
            .build();
        PlanetEntity entity3 = PlanetEntity.builder()
            .planetId(PLANET_ID_3)
            .gameId(GAME_ID_1)
            .build();
        PlanetEntity entity4 = PlanetEntity.builder()
            .planetId(PLANET_ID_4)
            .gameId(GAME_ID_2)
            .build();
