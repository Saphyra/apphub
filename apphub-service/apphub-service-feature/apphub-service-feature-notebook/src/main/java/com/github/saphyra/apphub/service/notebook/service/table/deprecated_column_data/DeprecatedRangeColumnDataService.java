...
class DeprecatedRangeColumnDataService extends ContentBasedColumnDataService {
    private final ObjectMapper objectMapper;

    DeprecatedRangeColumnDataService(ContentDao contentDao, ContentBasedColumnProxy proxy, ObjectMapper objectMapper) {
