...
public class DeprecatedTableEditionService {
    ...
    public EditTableResponse editTable(UUID listItemId, EditTableRequest request) {
        editTableRequestValidator.validate(null, listItemId, request);
        ...
        return EditTableResponse.builder()
            .tableResponse(tableQueryService.getTable(null, listItemId))
