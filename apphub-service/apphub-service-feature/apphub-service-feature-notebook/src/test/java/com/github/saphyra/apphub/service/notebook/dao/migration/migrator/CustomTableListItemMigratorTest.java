...
class CustomTableListItemMigratorTest {
    @Mock
    ...
    @Test
    void getType() {
        CustomTableListItemMigrator underTest = new CustomTableListItemMigrator(listItemMigratorUtil, commonListItemDao);

        assertThat(underTest.getType()).isEqualTo(ListItemType.CUSTOM_TABLE);
    }
