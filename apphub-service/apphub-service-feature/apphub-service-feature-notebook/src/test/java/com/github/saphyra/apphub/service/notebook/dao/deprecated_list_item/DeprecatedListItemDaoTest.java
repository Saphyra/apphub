...
public class DeprecatedListItemDaoTest {
    ...
    @InjectMocks
    private DeprecatedListItemDao underTest;

    @Mock
    private DeprecatedListItem domain;
    ...
    public void getByUserIdAndType() {
        ...
        List<DeprecatedListItem> result = underTest.getByUserIdAndType(USER_ID, ListItemType.CHECKLIST);
    ...
    public void findById() {
        ...
        Optional<DeprecatedListItem> result = underTest.findById(LIST_ITEM_ID);
    ...
    public void getByUserIdAndParent() {
        ...
        List<DeprecatedListItem> result = underTest.getByUserIdAndParent(USER_ID, PARENT);
    ...
    public void getByUserId() {
        ...
        List<DeprecatedListItem> result = underTest.getByUserId(USER_ID);
