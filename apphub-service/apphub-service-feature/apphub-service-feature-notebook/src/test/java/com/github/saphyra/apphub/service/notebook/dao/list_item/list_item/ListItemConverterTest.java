...
class ListItemConverterTest {
    ...
    private static final String ENCRYPTED_PINNED = "encrypted-pinned";
    ...
    void convertEntity() {
        ...
        given(booleanEncryptor.decrypt(ENCRYPTED_ARCHIVED, ACCESS_TOKEN_USER_ID_STRING, LIST_ITEM_ID_STRING, COLUMN_ARCHIVED)).willReturn(false);
        given(stringEncryptor.decrypt(ENCRYPTED_DATA, ACCESS_TOKEN_USER_ID_STRING, LIST_ITEM_ID_STRING, COLUMN_DATA)).willReturn(DECRYPTED_DATA);
        ...
        assertThat(result.getData()).isEqualTo(DECRYPTED_DATA);
    }
    ...
    void convertDomain() {
        ...
        given(booleanEncryptor.encrypt(false, ACCESS_TOKEN_USER_ID_STRING, LIST_ITEM_ID_STRING, COLUMN_ARCHIVED)).willReturn(ENCRYPTED_ARCHIVED);
        given(stringEncryptor.encrypt(DECRYPTED_DATA, ACCESS_TOKEN_USER_ID_STRING, LIST_ITEM_ID_STRING, COLUMN_DATA)).willReturn(ENCRYPTED_DATA);
