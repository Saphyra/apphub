...
class TextMigratorTest {
    private static final UUID LIST_ITEM_ID = UUID.randomUUID();
    private static final String TEXT_CONTENT = "some text content";
    ...
    @InjectMocks
    private TextMigrator underTest;
    ...
    @Test
    void getType() {
        assertThat(underTest.getType()).isEqualTo(ListItemType.TEXT);
    }

    @Test
    void migrate() {
        given(content.getContent()).willReturn(TEXT_CONTENT);
        ...
        given(listItemMigratorUtil.migrate(original, TEXT_CONTENT)).willReturn(listItem);
