...
class TableListItemMigratorTest {
    @Mock
    ...
    @Test
    void getType() {
        TableListItemMigrator underTest = new TableListItemMigrator(listItemMigratorUtil, commonListItemDao);

        assertThat(underTest.getType()).isEqualTo(ListItemType.TABLE);
    }
