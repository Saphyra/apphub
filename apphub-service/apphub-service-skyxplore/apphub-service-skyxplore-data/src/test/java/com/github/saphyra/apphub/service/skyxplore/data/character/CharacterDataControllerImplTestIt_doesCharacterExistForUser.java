...
public class CharacterDataControllerImplTestIt_doesCharacterExistForUser {
    ...
    public void characterExists() {
        ...
        assertThat(Boolean.parseBoolean(response.getBody().asString())).isTrue();
    }
    ...
    public void characterDoesNotExist() {
        ...
        assertThat(Boolean.parseBoolean(response.getBody().asString())).isFalse();
    }
}