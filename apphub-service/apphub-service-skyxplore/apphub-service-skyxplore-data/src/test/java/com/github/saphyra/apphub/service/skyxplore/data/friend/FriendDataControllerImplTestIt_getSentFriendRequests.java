...
public class FriendDataControllerImplTestIt_getSentFriendRequests {
    ...
    public void getSentFriendRequests() {
        ...
        List<SentFriendRequestResponse> friendRequests = Arrays.stream(response.getBody().as(SentFriendRequestResponse[].class))
            .collect(Collectors.toList());

        assertThat(friendRequests).containsExactly(SentFriendRequestResponse.builder().friendRequestId(friendRequestId).friendName(CHARACTER_NAME).build());
    }
}