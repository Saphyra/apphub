...
public class FriendDataControllerImplTestIt_acceptFriendRequest {
    ...
    public void friendRequestNotFound() {
        Response response = RequestFactory.createAuthorizedRequest(accessTokenHeaderConverter.convertDomain(ACCESS_TOKEN_HEADER))
            .post(UrlFactory.create(serverPort, Endpoints.SKYXPLORE_ACCEPT_FRIEND_REQUEST, "friendRequestId", UUID.randomUUID()));
    ...
    public void forbiddenOperation() {
        ...
        Response response = RequestFactory.createAuthorizedRequest(accessTokenHeaderConverter.convertDomain(ACCESS_TOKEN_HEADER))
            .post(UrlFactory.create(serverPort, Endpoints.SKYXPLORE_ACCEPT_FRIEND_REQUEST, "friendRequestId", FRIEND_REQUEST_ID));
    ...
    public void acceptFriendRequest() {
        ...
        assertThat(friendshipDao.findByFriendIds(USER_ID_1, USER_ID_2)).isNotEmpty();
    }
}