...
class ConstructBuildingModuleProcessTest {
    ...
    @Mock
    private ConstructBuildingModuleProcessHelper processHelper;
    ...
    void work_productionOrdersNotCompleted() {
        given(applicationContextProxy.getBean(ConstructBuildingModuleProcessHelper.class)).willReturn(processHelper);
