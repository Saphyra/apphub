...
class PlanetToModelConverterTest {
    ...
    private final PlanetToModelConverter underTest = new PlanetToModelConverter();
    ...
    void convert() {
        ...
        PlanetModel result = underTest.convert(GAME_ID, planet);
