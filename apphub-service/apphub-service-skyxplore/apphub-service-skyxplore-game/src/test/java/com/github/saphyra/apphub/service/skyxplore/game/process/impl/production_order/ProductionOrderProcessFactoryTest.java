...
public class ProductionOrderProcessFactoryTest {
    ...
    public void create() throws NoSuchFieldException, IllegalAccessException {
        ...
        List<ProductionOrderProcess> result = underTest.create(gameData, EXTERNAL_REFERENCE, PLANET_ID, RESERVED_STORAGE_ID);
    ...
    public void createFromModel() throws NoSuchFieldException, IllegalAccessException {
        ...
        given(gameData.getAllocatedResources()).willReturn(allocatedResources);
        given(allocatedResources.findByAllocatedResourceId(ALLOCATED_RESOURCE_ID)).willReturn(Optional.of(allocatedResource));
