...
public class BuildingController implements SkyXploreGameBuildingController {
    ...
    @Override
    public SurfaceBuildingResponse constructNewBuilding(OneParamRequest<String> dataId, UUID planetId, UUID surfaceId, AccessTokenHeader accessTokenHeader) {
    ...
    @Override
    public ConstructionResponse upgradeBuilding(UUID planetId, UUID buildingId, AccessTokenHeader accessTokenHeader) {
