...
public class StorageCalculator {
    ...
    public int calculateCapacity(Planet planet, StorageType storageType) {
        List<Building> buildings = planet.getSurfaces()
            .values()
            .stream()
        ...
        return calculateCapacity(storageType, buildings);
    }

    public int calculateCapacity(StorageType storageType, List<Building> buildings) {
