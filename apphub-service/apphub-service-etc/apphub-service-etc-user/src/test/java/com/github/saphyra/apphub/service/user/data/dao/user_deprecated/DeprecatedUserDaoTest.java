...
public class DeprecatedUserDaoTest {
    ...
    @Mock
    private DeprecatedUserRepository repository;
    ...
    private DeprecatedUserDao underTest;

    @Mock
    private UserEntity entity;

    @Mock
    private DeprecatedUser user;

    @BeforeEach
    public void setUp() {
        underTest = DeprecatedUserDao.builder()
            .converter(converter)
    ...
    public void findByEmail() {
        ...
        Optional<DeprecatedUser> result = underTest.findByEmail(EMAIL);
    ...
    public void findByUsername() {
        ...
        Optional<DeprecatedUser> result = underTest.findByUsername(USERNAME);
    ...
    public void findByIdValidated() {
        ...
        DeprecatedUser result = underTest.findByIdValidated(USER_ID);
    ...
    public void getByUsernameOrEmailContainingIgnoreCase() {
        ...
        List<DeprecatedUser> result = underTest.getByUsernameOrEmailContainingIgnoreCase(QUERY_STRING);
    ...
    public void getUsersMarkedToDelete() {
        ...
        List<DeprecatedUser> result = underTest.getUsersMarkedToDelete();
    ...
    public void findById() {
        ...
        Optional<DeprecatedUser> result = underTest.findById(USER_ID);
