window.Mapping = new function(){
    ...
    const endpoints = {
        ...
        SKYXPLORE_PLANET_DELETE_STORAGE_SETTING: new Endpoint("/api/skyxplore/game/storage-settings/{storageSettingId}", HttpMethod.DELETE),
        SKYXPLORE_PLANET_EDIT_STORAGE_SETTING: new Endpoint("/api/skyxplore/game/storage-settings", HttpMethod.POST),
        SKYXPLORE_PLANET_GET_POPULATION: new Endpoint("/api/skyxplore/game/planet/{planetId}/citizen", HttpMethod.GET),
        SKYXPLORE_PLANET_RENAME_CITIZEN: new Endpoint("/api/skyxplore/game/citizen/{citizenId}/rename", HttpMethod.POST),
