(function ViewEventController(){
    ...
    function saveModifications(){
        ...
        const request = new Request(Mapping.getEndpoint("CALENDAR_OCCURRENCE_EDIT", {occurrenceId: currentEvent.occurrenceId}), payload);
    ...
    function markAsDone(){
        ...
        const request = new Request(Mapping.getEndpoint("CALENDAR_OCCURRENCE_DONE", {occurrenceId: currentEvent.occurrenceId}), payload);
            request.convertResponse = jsonConverter;
            request.processValidResponse = function(days){
                eventProcessor.processEvent(new Event(events.EVENT_CHANGED, days));
    ...
    function markAsDefault(){
        ...
        const request = new Request(Mapping.getEndpoint("CALENDAR_OCCURRENCE_DEFAULT", {occurrenceId: currentEvent.occurrenceId}), payload);
            request.convertResponse = jsonConverter;
            request.processValidResponse = function(days){
                eventProcessor.processEvent(new Event(events.EVENT_CHANGED, days));
    ...
    function markAsSnoozed(){
        ...
        const request = new Request(Mapping.getEndpoint("CALENDAR_OCCURRENCE_SNOOZED", {occurrenceId: currentEvent.occurrenceId}), payload);
            request.convertResponse = jsonConverter;
            request.processValidResponse = function(days){
                eventProcessor.processEvent(new Event(events.EVENT_CHANGED, days));
    ...
    function deleteEvent(){
        ...
        confirmationService.openDialog(
            ...
            function(){
                const request = new Request(Mapping.getEndpoint("CALENDAR_EVENT_DELETE", {eventId: currentEvent.eventId}), payload);
                    request.convertResponse = jsonConverter;
                    request.processValidResponse = function(days){
