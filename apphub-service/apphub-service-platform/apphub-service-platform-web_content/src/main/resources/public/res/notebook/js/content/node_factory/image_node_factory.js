function imageNodeFactory(parent, itemDetails, displayOpenParentCategoryButton){
    const node = document.createElement("DIV");
        ...
        node.onclick = function(){
            imageViewController.viewImage(itemDetails.id, itemDetails.title, itemDetails.value);
        }
