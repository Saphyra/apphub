...
window.monthLocalization = localization.loadCustomLocalization("calendar", "months");
const CURRENT_DATE = LocalDate.now();

scriptLoader.loadScript("/res/calendar/js/calendar_controller.js");
scriptLoader.loadScript("/res/calendar/js/daily_tasks_controller.js");
scriptLoader.loadScript("/res/calendar/js/create_event_controller.js");
scriptLoader.loadScript("/res/calendar/js/view_event_controller.js");
scriptLoader.loadScript("/res/calendar/js/search_controller.js");

(function PageController(){
    $(document).ready(function(){
        localization.loadLocalization("calendar", "calendar");
