...
class AuthorizationFailedAuthResultHandlerTest {
    private static final String REDIRECT_URL = "redirect-url";

    private final AuthenticationFailedWebAuthResultHandler underTest = new AuthenticationFailedWebAuthResultHandler(REDIRECT_URL);
