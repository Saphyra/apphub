...
public class AuthorizationFailedAuthResultHandlerTest {
    @InjectMocks
    private AuthorizationFailedAuthResultHandler authorizationFailedAuthResultHandler;
    ...
    public void handle() {
        ...
        Mono<Void> result = authorizationFailedAuthResultHandler.handle(exchange, filterChain);
