...
public class AuthorizationClientProxy {
    ...
    public AuthorizationResponse authorize(AuthorizationRequest request) {
        return authorizationClient.authorize(request, commonConfigProperties.getDefaultLocale());
    }

    public List<String> getRoles(UUID userId) {
        return authorizationClient.getRoles(userId, commonConfigProperties.getDefaultLocale());
    }
}
