...
@Slf4j
//TODO unit test
class DateTimeColumnDataService implements ColumnDataService {
    ...
    public boolean canProcess(ColumnType columnType) {
        return columnType == ColumnType.DATE_TIME;
    }
    ...
    public Optional<TableFileUploadResponse> save(UUID userId, UUID listItemId, UUID rowId, TableColumnModel model) {
        ...
        ColumnTypeDto columnTypeDto = columnTypeFactory.create(column.getDimensionId(), userId, ColumnType.DATE_TIME);
    ...
    public void clone(ListItem clone, UUID rowId, Dimension originalColumn) {
        ...
        ColumnTypeDto columnTypeDto = columnTypeFactory.create(clonedColumn.getDimensionId(), clone.getUserId(), ColumnType.DATE_TIME);
        columnTypeDao.save(columnTypeDto);
