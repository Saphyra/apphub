...
class FileColumnDataService extends FileBasedColumnDataService {
    ...
    public FileColumnDataService(FileBasedColumnProxy proxy, FileDao fileDao, ObjectMapperWrapper objectMapperWrapper, FileMetadataValidator fileMetadataValidator) {
        super(ColumnType.FILE, proxy, fileDao);
