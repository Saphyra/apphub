...
class ImageColumnDataService extends FileBasedColumnDataService {
    ImageColumnDataService(FileBasedColumnProxy proxy, FileDao fileDao, ObjectMapper objectMapper, FileMetadataValidator fileMetadataValidator) {
        super(ColumnType.IMAGE, proxy, fileDao, objectMapper, fileMetadataValidator);
    }
}
