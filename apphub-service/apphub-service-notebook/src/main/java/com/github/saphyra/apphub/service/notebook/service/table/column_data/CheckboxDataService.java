...
@Slf4j
//TODO unit test
class CheckboxDataService implements ColumnDataService {
    ...
    public Optional<TableFileUploadResponse> save(UUID userId, UUID listItemId, UUID rowId, TableColumnModel model) {
        ...
        ColumnTypeDto columnTypeDto = columnTypeFactory.create(column.getDimensionId(), userId, ColumnType.CHECKBOX);
    ...
    public void clone(ListItem clone, UUID rowId, Dimension originalColumn) {
        ...
        ColumnTypeDto columnTypeDto = columnTypeFactory.create(clonedColumn.getDimensionId(), clone.getUserId(), ColumnType.CHECKBOX);
        columnTypeDao.save(columnTypeDto);
