...
class EdMessageProcessorTest {
    ...
    void verify() throws ExecutionException, InterruptedException {
        ...
        then(performanceReporter).should().wrap(any(Callable.class), eq(PerformanceReportingTopic.ELITE_BASE_MESSAGE_PROCESSING), eq(PerformanceReportingKey.QUERY_ARRIVED_MESSAGES.name()));
    }
