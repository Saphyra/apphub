...
public class UserDataControllerImplTestIt {
    ...
    public void findByEmail_notFound() {
        ...
        Response response = RequestFactory.createRequest()
            .get(UrlFactory.create(serverPort, Endpoint.INTERNAL_FIND_USER_BY_EMAIL, paramMap));
    ...
    public void findByEmail() {
        ...
        InternalUserResponse internalUserResponse = objectMapperWrapper.readValue(response.getBody().asString(), InternalUserResponse.class);
        assertThat(internalUserResponse.getUserId()).isEqualTo(USER_ID);
        assertThat(internalUserResponse.getPasswordHash()).isEqualTo(PASSWORD);
        assertThat(internalUserResponse.getUsername()).isEqualTo(USERNAME);
        assertThat(internalUserResponse.getEmail()).isEqualTo(EMAIL);
    }
    ...
    public void getLanguage_userNotFound() {
        ...
        Response response = RequestFactory.createRequest()
            .get(UrlFactory.create(serverPort, Endpoint.INTERNAL_GET_USER_LANGUAGE, paramMap));
    ...
    public void register_emailNull() {
        Response response = RequestFactory.createRequest()
            ...
            .post(UrlFactory.create(serverPort, Endpoint.REGISTER));
