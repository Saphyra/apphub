...
public class AuthenticationControllerTestIt {
    ...
    private ObjectMapperWrapper objectMapperWrapper = new ObjectMapperWrapper(new ObjectMapper().disable(SerializationFeature.FAIL_ON_EMPTY_BEANS));
    ...
    public void deleteExpiredAccessTokens() {
        ...
        Response response = RequestFactory.createRequest()
            ...
            .post(UrlFactory.create(serverPort, Endpoint.DELETE_EXPIRED_ACCESS_TOKENS_EVENT));
    ...
    public void updateLastAccess() {
        ...
        Response response = RequestFactory.createRequest()
            .body(objectMapperWrapper.writeValueAsString(request))
            .post(UrlFactory.create(serverPort, Endpoint.REFRESH_ACCESS_TOKEN_EXPIRATION_EVENT));
    ...
    public void login_badPassword() {
        InternalUserResponse internalUserResponse = InternalUserResponse.builder()
            .userId(USER_ID)
    ...
    private Response getLoginResponse(LoginRequest loginRequest) {
        return RequestFactory.createRequest()
            ...
            .post(UrlFactory.create(serverPort, Endpoint.LOGIN));
    }
    ...
    public void logout() {
        ...
        Response response = RequestFactory.createRequest()
            ...
            .post(UrlFactory.create(serverPort, Endpoint.LOGOUT));
