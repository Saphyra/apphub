...
public class RoleControllerImplTestIt_removeRole {
    ...
    @Test
    public void removeRole_nullUserId() {
    ...
    @Test
    public void removeRole_blankRole() {
        AccessTokenHeader accessTokenHeader = AccessTokenHeader.builder()
            .accessTokenId(UUID.randomUUID())
            .userId(UUID.randomUUID())
            .roles(Arrays.asList(ADMIN_ROLE))
    ...
    @Test
    public void removeRole_roleNotFound() {
        ...
        assertThat(response.getStatusCode()).isEqualTo(HttpStatus.NOT_FOUND.value());
        ErrorResponse errorResponse = response.getBody().as(ErrorResponse.class);
        assertThat(errorResponse.getErrorCode()).isEqualTo(ErrorCode.ROLE_NOT_FOUND);
        assertThat(errorResponse.getLocalizedMessage()).isEqualTo(LOCALIZED_MESSAGE);
    }
