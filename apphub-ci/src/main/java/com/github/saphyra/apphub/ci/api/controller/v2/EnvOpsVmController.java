...
class EnvOpsVmController {
    ...
    @PostMapping("/start")
    String startVm(@PathVariable("environment") Environment environment) {
    ...
    @PostMapping("/stop")
    String stopVm(@PathVariable("environment") Environment environment) {
    ...
    String deleteNamespace(@PathVariable("environment") Environment environment) {
