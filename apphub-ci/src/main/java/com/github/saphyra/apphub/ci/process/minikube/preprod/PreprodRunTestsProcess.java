...
public class PreprodRunTestsProcess {
    ...
    public void runTests(String testGroups) {
        try {
            ...
            kubernetesPortForwarder.portForward(Constants.NAMESPACE_NAME_PREPROD, Constants.SERVICE_NAME_MAIN_GATEWAY, platformProperties.getMinikubeTestServerPort(), Constants.SERVICE_PORT);
