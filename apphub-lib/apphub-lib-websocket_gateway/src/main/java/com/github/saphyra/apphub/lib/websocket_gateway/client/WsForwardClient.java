package com.github.saphyra.apphub.lib.websocket_gateway.client;

import com.github.saphyra.apphub.lib.websocket_gateway.MessageFilter;
import com.github.saphyra.apphub.lib.websocket_gateway.utils.WebsocketConstant;
...
public class WsForwardClient {
    ...
    private WsForwardClient(String url, WebSocketSession webSocketSession,
                            MessageFilter messageFilter, HttpHeaders httpHeaders) {
        this.url = url;
