...
import com.github.saphyra.apphub.lib.websocket_gateway.server.AbstractWsServerHandler;
import com.github.saphyra.apphub.lib.websocket_gateway.server.DiscoveryForwardHandler;
import com.github.saphyra.apphub.lib.websocket_gateway.utils.CommonUtils;
...
public class WsForwardConfiguration {
    ...
    protected class WebsocketConfig implements WebSocketConfigurer {
        ...
        public void registerWebSocketHandlers(WebSocketHandlerRegistry webSocketHandlerRegistry) {
            Map<String, WsForwardProperties.ForwardHandler> handlers = wsForwardProperties.getHandlers();
        ...
        private WebSocketHandlerRegistration getRegistration(WebSocketHandlerRegistry registry,
                                                             WsForwardProperties.ForwardHandler handler) {
            // set handler
