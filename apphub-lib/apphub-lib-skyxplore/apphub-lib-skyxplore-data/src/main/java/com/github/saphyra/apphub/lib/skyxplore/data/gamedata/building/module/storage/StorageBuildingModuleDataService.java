...
@Component
public class StorageBuildingModuleDataService extends ValidationAbstractDataService<String, StorageBuildingModuleData> {
    public StorageBuildingModuleDataService(ContentLoaderFactory contentLoaderFactory, StorageBuildingModuleValidator validator) {
