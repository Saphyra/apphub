...
class DoubleEncryptorTest {
    ...
    @InjectMocks
    private DoubleEncryptor underTest;

    @Test
    void encrypt() {
        //GIVEN
        when(stringEncryptor.encrypt("2.0", KEY, ENTITY_ID, COLUMN)).thenReturn(ENCRYPTED_STRING);
        //WHEN
        String result = underTest.encrypt(2d, KEY, ENTITY_ID, COLUMN);
        //THEN
    ...
    void decrypt() {
        ...
        //WHEN
        Double result = underTest.decrypt(ENCRYPTED_STRING, KEY, ENTITY_ID, COLUMN);
        //THEN
    ...
    void decrypt_null() {
        ...
        //WHEN
        Double result = underTest.decrypt(null, KEY, ENTITY_ID, COLUMN);
        //THEN
