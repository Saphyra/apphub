...
public class CancelConstructionTest extends BackEndTest {
    ...
    public void constructNewBuilding(Language language) {
        ...
        UUID emptyDesertSurfaceId = findEmptySurface(language, accessTokenId, planetId);
    ...
    private UUID findEmptySurface(Language language, UUID accessTokenId, UUID planetId) {
