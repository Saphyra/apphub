...
public class AddRoleTest extends BackEndTest {
    ...
    public void addRole(Language language) {
        ...
        assertThat(responses.get(0).getRoles()).containsExactlyInAnyOrder(Constants.ROLE_TEST, Constants.ROLE_NOTEBOOK, Constants.ROLE_SKYXPLORE, Constants.ROLE_ACCESS);
    }
}
