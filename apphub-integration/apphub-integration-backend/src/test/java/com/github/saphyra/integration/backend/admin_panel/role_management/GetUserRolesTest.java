...
public class GetUserRolesTest extends BackEndTest {
    ...
    public void getRoles(Language language) {
        ...
        assertThat(userRoleResponse.getRoles()).containsExactlyInAnyOrder(Constants.ROLE_ADMIN, Constants.ROLE_NOTEBOOK, Constants.ROLE_SKYXPLORE, Constants.ROLE_ACCESS, Constants.ROLE_TRAINING);
    }
}
