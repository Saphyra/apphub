...
public class VillanyAteszStockItemInventoryActions {
    public static Response getEditCategoryResponse(int serverPort, UUID accessTokenId, UUID stockItemId, UUID stockCategoryId) {
        return RequestFactory.createAuthorizedRequest(accessTokenId)
            ...
            .post(UrlFactory.create(serverPort, VillanyAteszEndpoints.VILLANY_ATESZ_STOCK_INVENTORY_EDIT_CATEGORY, "stockItemId", stockItemId));
    }
    ...
    public static Response getItemsResponse(int serverPort, UUID accessTokenId) {
        return RequestFactory.createAuthorizedRequest(accessTokenId)
            .get(UrlFactory.create(serverPort, VillanyAteszEndpoints.VILLANY_ATESZ_STOCK_INVENTORY_GET_ITEMS));
    }
    ...
    public static Response getEditInventoriedResponse(int serverPort, UUID accessTokenId, UUID stockItemId, Boolean inventoried) {
        return RequestFactory.createAuthorizedRequest(accessTokenId)
            ...
            .post(UrlFactory.create(serverPort, VillanyAteszEndpoints.VILLANY_ATESZ_STOCK_INVENTORY_EDIT_INVENTORIED, "stockItemId", stockItemId));
    }
    ...
    public static Response getEditNameResponse(int serverPort, UUID accessTokenId, UUID stockItemId, String name) {
        return RequestFactory.createAuthorizedRequest(accessTokenId)
            ...
            .post(UrlFactory.create(serverPort, VillanyAteszEndpoints.VILLANY_ATESZ_STOCK_INVENTORY_EDIT_NAME, "stockItemId", stockItemId));
    }
    ...
    public static Response getEditSerialNumberResponse(int serverPort, UUID accessTokenId, UUID stockItemId, String serialNumber) {
        return RequestFactory.createAuthorizedRequest(accessTokenId)
            ...
            .post(UrlFactory.create(serverPort, VillanyAteszEndpoints.VILLANY_ATESZ_STOCK_INVENTORY_EDIT_SERIAL_NUMBER, "stockItemId", stockItemId));
    }
    ...
    public static Response getEditInCarResponse(int serverPort, UUID accessTokenId, UUID stockItemId, Integer inCar) {
        return RequestFactory.createAuthorizedRequest(accessTokenId)
            ...
            .post(UrlFactory.create(serverPort, VillanyAteszEndpoints.VILLANY_ATESZ_STOCK_INVENTORY_EDIT_IN_CAR, "stockItemId", stockItemId));
    ...
    public static Response getEditInStorageResponse(int serverPort, UUID accessTokenId, UUID stockItemId, Integer inStorage) {
        return RequestFactory.createAuthorizedRequest(accessTokenId)
            ...
            .post(UrlFactory.create(serverPort, VillanyAteszEndpoints.VILLANY_ATESZ_STOCK_INVENTORY_EDIT_IN_STORAGE, "stockItemId", stockItemId));
    }
    ...
    public static Response getMoveStockToCarResponse(int serverPort, UUID accessTokenId, UUID stockItemId, Integer amount) {
        return RequestFactory.createAuthorizedRequest(accessTokenId)
            ...
            .post(UrlFactory.create(serverPort, VillanyAteszEndpoints.VILLANY_ATESZ_MOVE_STOCK_TO_CAR, "stockItemId", stockItemId));
    }
    ...
    public static Response getMoveStockToStorageResponse(int serverPort, UUID accessTokenId, UUID stockItemId, int amount) {
        return RequestFactory.createAuthorizedRequest(accessTokenId)
            .body(new OneParamRequest<>(amount))
            .post(UrlFactory.create(serverPort, VillanyAteszEndpoints.VILLANY_ATESZ_MOVE_STOCK_TO_STORAGE, "stockItemId", stockItemId));
    }
    ...
    public static Response getEditBarCodeResponse(int serverPort, UUID accessTokenId, UUID stockItemId, String barCode) {
        return RequestFactory.createAuthorizedRequest(accessTokenId)
            ...
            .post(UrlFactory.create(serverPort, VillanyAteszEndpoints.VILLANY_ATESZ_STOCK_INVENTORY_EDIT_BAR_CODE, "stockItemId", stockItemId));
    }
    ...
    public static Response getResetInventoriedResponse(int serverPort, UUID accessTokenId) {
        return RequestFactory.createAuthorizedRequest(accessTokenId)
            .post(UrlFactory.create(serverPort, VillanyAteszEndpoints.VILLANY_ATESZ_RESET_INVENTORIED));
    }
    ...
    public static Response getEditMarkedForAcquisitionResponse(int serverPort, UUID accessTokenId, UUID stockItemId, Boolean markedForAcquisition) {
        return RequestFactory.createAuthorizedRequest(accessTokenId)
            ...
            .post(UrlFactory.create(serverPort, VillanyAteszEndpoints.VILLANY_ATESZ_STOCK_INVENTORY_EDIT_MARKED_FOR_ACQUISITION, "stockItemId", stockItemId));
    }
}
