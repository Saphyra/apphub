...
public class SkyXploreSurfaceActions {
    ...
    public static Response getTerraformResponse(int serverPort, UUID accessTokenId, UUID planetId, UUID surfaceId, String surfaceType) {
        return RequestFactory.createAuthorizedRequest(accessTokenId)
            ...
            .post(UrlFactory.create(serverPort, Endpoints.SKYXPLORE_GAME_TERRAFORM_SURFACE, CollectionUtils.toMap(new BiWrapper<>("planetId", planetId), new BiWrapper<>("surfaceId", surfaceId))));
    }
    ...
    public static Response getCancelTerraformationResponse(int serverPort, UUID accessTokenId, UUID planetId, UUID surfaceId) {
        return RequestFactory.createAuthorizedRequest(accessTokenId)
            .delete(UrlFactory.create(serverPort, Endpoints.SKYXPLORE_GAME_CANCEL_TERRAFORMATION, CollectionUtils.toMap(new BiWrapper<>("planetId", planetId), new BiWrapper<>("surfaceId", surfaceId))));
    }
