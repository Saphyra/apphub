...
public class CreateFriendRequestTest extends BackEndTest {
    ...
    private static void characterNotFound(UUID accessTokenId1) {
        Response characterNotFoundResponse = SkyXploreFriendActions.getCreateFriendRequestResponse(accessTokenId1, UUID.randomUUID());
    ...
    private static void createFriendRequest(UUID accessTokenId1, UUID accessTokenId2, SkyXploreCharacterModel model1, SkyXploreCharacterModel model2, UUID userId2) {
        ...
        SentFriendRequestResponse sentFriendRequestResponse = SkyXploreFriendActions.createFriendRequest(accessTokenId1, userId2);

        assertThat(sentFriendRequestResponse.getFriendName()).isEqualTo(model2.getName());

        List<SentFriendRequestResponse> sentFriendRequests = SkyXploreFriendActions.getSentFriendRequests(accessTokenId1);
        assertThat(sentFriendRequests).hasSize(1);
        assertThat(sentFriendRequests.get(0).getFriendName()).isEqualTo(model2.getName());
        List<IncomingFriendRequestResponse> incomingFriendRequests = SkyXploreFriendActions.getIncomingFriendRequests(accessTokenId2);
    ...
    private static void friendRequestAlreadyExists(UUID accessTokenId1, UUID userId2) {
        Response friendRequestAlreadyExistsResponse = SkyXploreFriendActions.getCreateFriendRequestResponse(accessTokenId1, userId2);
    ...
    private static void friendshipAlreadyExists(UUID accessTokenId1, UUID accessTokenId2, UUID userId2) {
        ...
        SkyXploreFriendActions.acceptFriendRequest(accessTokenId2, friendRequestId);
        Response friendshipAlreadyExistsResponse = SkyXploreFriendActions.getCreateFriendRequestResponse(accessTokenId1, userId2);
