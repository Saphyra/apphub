...
public class ExitFromLobbyTest extends BackEndTest {
    ...
    public void hostLeftTheLobby() {
        ...
        UUID accessTokenId4 = IndexPageActions.registerAndLogin(userData4);
        SkyXploreCharacterActions.createOrUpdateCharacter(accessTokenId4, characterModel4);
        ...
        SkyXploreFriendActions.setUpFriendship(accessTokenId3, accessTokenId4, userId4);
        SkyXploreFriendActions.setUpFriendship(accessTokenId2, accessTokenId4, userId4);

        SkyXploreLobbyActions.createLobby(accessTokenId1, GAME_NAME);

        SkyXploreLobbyActions.inviteToLobby(accessTokenId1, userId2);
        SkyXploreLobbyActions.inviteToLobby(accessTokenId1, userId3);
        SkyXploreLobbyActions.acceptInvitation(accessTokenId2, userId1);
        SkyXploreLobbyActions.acceptInvitation(accessTokenId3, userId1);

        ApphubWsClient wsClient = ApphubWsClient.createSkyXploreLobby(accessTokenId2, accessTokenId2);
    ...
    private static ApphubWsClient memberLeft(SkyXploreCharacterModel characterModel3, UUID accessTokenId3, UUID userId3, UUID accessTokenId4, UUID userId4, ApphubWsClient wsClient) {
        SkyXploreLobbyActions.inviteToLobby(accessTokenId3, userId4);
        ApphubWsClient invitationClient = ApphubWsClient.createSkyXploreLobbyInvitation(accessTokenId4, accessTokenId4);

        SkyXploreLobbyActions.exitFromLobby(accessTokenId3);
    ...
    private static void hostLeft(SkyXploreCharacterModel characterModel1, UUID accessTokenId1, UUID userId1, UUID accessTokenId2, UUID userId2, UUID userId4, ApphubWsClient wsClient, ApphubWsClient mainMenuClient) {
        ...
        SkyXploreLobbyActions.inviteToLobby(accessTokenId2, userId4);

        SkyXploreLobbyActions.exitFromLobby(accessTokenId1);
        ...
        Response response = SkyXploreLobbyActions.getLobbyPlayersResponse(accessTokenId2);
