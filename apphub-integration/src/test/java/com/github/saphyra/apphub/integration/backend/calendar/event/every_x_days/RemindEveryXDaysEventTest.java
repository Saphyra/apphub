...
public class RemindEveryXDaysEventTest extends BackEndTest {
    ...
    private void edit(UUID accessTokenId, UUID eventId) {
        ...
        assertThat(occurrences.get(EventRequestFactory.NEW_START_DATE.minusDays(NEW_REMIND_ME_BEFORE_DAYS)))
        ...
        assertThat(occurrences.get(EventRequestFactory.NEW_START_DATE.plusDays(EventRequestFactory.NEW_REPETITION_DATA_EVERY_X_DAYS - NEW_REMIND_ME_BEFORE_DAYS)))
            .returns(OccurrenceStatus.REMINDER, OccurrenceResponse::getStatus);
