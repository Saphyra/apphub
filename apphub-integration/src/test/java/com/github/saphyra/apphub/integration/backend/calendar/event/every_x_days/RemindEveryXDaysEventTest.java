...
public class RemindEveryXDaysEventTest extends BackEndTest {
    ...
    public void remindEveryXDaysEvent() {
    ...
    private void edit(UUID accessTokenId, UUID eventId) {
        ...
        assertThat(occurrences.get(EventRequestFactory.NEW_START_DATE.minusDays(EventRequestFactory.NEW_REMIND_ME_BEFORE_DAYS)))
        ...
        assertThat(occurrences.get(EventRequestFactory.NEW_START_DATE.plusDays(EventRequestFactory.NEW_REPETITION_DATA_EVERY_X_DAYS - EventRequestFactory.NEW_REMIND_ME_BEFORE_DAYS)))
            .returns(OccurrenceStatus.REMINDER, OccurrenceResponse::getStatus);
    ...
    private UUID create(UUID accessTokenId) {
        ...
        assertThat(occurrences.get(EventRequestFactory.DEFAULT_START_DATE))
            .returns(OccurrenceStatus.PENDING, OccurrenceResponse::getStatus);
        assertThat(occurrences.get(EventRequestFactory.DEFAULT_START_DATE.plusDays(EventRequestFactory.DEFAULT_REPETITION_DATA_EVERY_X_DAYS - REMIND_ME_BEFORE_DAYS)))
            .returns(OccurrenceStatus.REMINDER, OccurrenceResponse::getStatus);
