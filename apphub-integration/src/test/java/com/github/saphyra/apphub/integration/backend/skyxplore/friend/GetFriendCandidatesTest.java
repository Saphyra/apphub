...
public class GetFriendCandidatesTest extends BackEndTest {
    ...
    public void getFriendCandidates() {
        ...
        SkyXploreCharacterActions.createOrUpdateCharacter(accessTokenId4, model4);

        SkyXploreFriendActions.createFriendRequest(accessTokenId, userId2);

        SkyXploreFriendActions.createFriendRequest(accessTokenId, userId3);
        ...
        SkyXploreFriendActions.acceptFriendRequest(accessTokenId3, friendRequestId);

        List<SkyXploreCharacterModel> result = SkyXploreFriendActions.getFriendCandidates(accessTokenId, characterIdentifier.toUpperCase());
