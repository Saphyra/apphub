...
public class GetFriendRequestsTest extends BackEndTest {
    ...
    public void getFriendRequests() {
        ...
        UUID accessTokenI1 = IndexPageActions.registerAndLogin(userData1);
        ...
        SkyXploreCharacterActions.createOrUpdateCharacter(accessTokenI1, model);
        ...
        SkyXploreFriendActions.createFriendRequest(accessTokenI1, userId2);

        List<SentFriendRequestResponse> sentFriendRequests = SkyXploreFriendActions.getSentFriendRequests(accessTokenI1);
