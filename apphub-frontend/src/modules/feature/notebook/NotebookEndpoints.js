...
export const NOTEBOOK_UPDATE_CHECKLIST_ITEM_STATUS = new Endpoint(RequestMethod.POST, "/api/notebook/checklist/{listItemId}/item/{checklistItemId}/status");
export const NOTEBOOK_UPDATE_CHECKLIST_ITEM_CONTENT = new Endpoint(RequestMethod.POST, "/api/notebook/checklist/{listItemId}/item/{checklistItemId}/content");
export const NOTEBOOK_DELETE_CHECKLIST_ITEM = new Endpoint(RequestMethod.DELETE, "/api/notebook/checklist/{listItemId}/item/{checklistItemId}");
...
export const NOTEBOOK_TABLE_SET_ROW_STATUS = new Endpoint(RequestMethod.POST, "/api/notebook/table/{listItemId}/row/{rowId}/status");
export const NOTEBOOK_TABLE_SET_CHECKBOX_COLUMN_STATUS = new Endpoint(RequestMethod.POST, "/api/notebook/table/{listItemId}/row/{rowId}/column/{columnId}/status");
