...
export const CALENDAR_GET_OPERATIONS = new Endpoint(RequestMethod.GET, "/api/calendar/shared/{type}/operations");
export const CALENDAR_SHARE_OBJECT = new Endpoint(RequestMethod.PUT, "/api/calendar/shared");
export const CALENDAR_SHARE_EDIT_OPERATIONS = new Endpoint(RequestMethod.POST, "/api/calendar/shared/{type}/{id}/operations/{sharedWith}");
export const CALENDAR_UNSHARE_OBJECT = new Endpoint(RequestMethod.DELETE, "/api/calendar/shared/{type}/{id}/operations/{sharedWith}");